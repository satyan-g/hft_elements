#ifndef HFT_ELEMENTS_MBO_MBL_ORDER_BOOK_H
#define HFT_ELEMENTS_MBO_MBL_ORDER_BOOK_H
...
private:
  ...
  // Helper methods
  void handle_add(const dbn::MboEvent& event) noexcept;
  void handle_cancel(const dbn::MboEvent& event) noexcept;
  void handle_modify(const dbn::MboEvent& event) noexcept;
