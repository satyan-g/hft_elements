#ifndef HFT_ELEMENTS_SNAPSHOT_GENERATOR_H
#define HFT_ELEMENTS_SNAPSHOT_GENERATOR_H

#include "hft_elements/snapshot/json_builder.h"
...
template<typename BookManagerT = mbo_mbl::BookManager>
...
public:
  ...
  std::string_view generate(const common::Symbol& symbol) noexcept {
    ...
    std::array<mbo_mbl::PriceLevel, mbo_mbl::OrderBook::MAX_LEVELS> bids, asks;
