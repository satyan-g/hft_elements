#ifndef HFT_ELEMENTS_SERIALIZATION_JSON_BUILDER_H
#define HFT_ELEMENTS_SERIALIZATION_JSON_BUILDER_H

#include "hft_elements/common/types.h"
#include "hft_elements/orderbook/order_book.h"
#include <string>
#include <string_view>
#include <array>
...
public:
  ...
  std::string_view build(
    ...
    const std::array<orderbook::PriceLevel, orderbook::OrderBook::MAX_LEVELS>& bids,
    const std::array<orderbook::PriceLevel, orderbook::OrderBook::MAX_LEVELS>& asks,
    size_t bid_count,
